...
Each [GitHub Release](https://github.com/geeknonerd/stuntdouble/releases) is built to include the Linux x86_64, macOS arm64, and Windows x86_64 archives, `SHA256SUMS`, the CycloneDX SBOM, `ctx-api-v1.d.ts`, release notes, and the GHCR tag plus digest. Verify the provenance of a downloaded archive:
...
- Linux x86_64, macOS arm64, and Windows x86_64 binaries plus a container image (release automation wired in T9).
